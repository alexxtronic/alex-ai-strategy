...
export default function RoiPage() {
  return (
    <main>
      ...
      <section className="inline-cta"><div><h2>Turn the model into a real opportunity.</h2></div><p>We will map the workflow, challenge the assumptions, and identify whether there is a practical place to begin.</p><a className="button button-dark" href="/contact"><span>Talk to us</span></a></section>
      <SiteFooter />
    </main>
  );
}
