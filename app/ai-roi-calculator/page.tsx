...
export default function RoiPage() {
  return (
    <main>
      <SiteHeader compact />
      <section className="page-hero roi-hero"><h1>Make the AI business case inspectable.</h1><p>Estimate the baseline cost of a workflow, the capacity AI could create, and whether the first-year economics survive more realistic assumptions.</p></section>
      <RoiCalculator />
      ...
      <section className="inline-cta"><div><h2>Turn the model into a real opportunity.</h2></div><p>We will map the workflow, challenge the assumptions, and identify whether there is a practical place to begin.</p><a className="button button-dark" href="/contact">Talk to us <span aria-hidden="true">↗</span></a></section>
      <SiteFooter />
    </main>
  );
}
