    ...
    <>
      <form className="contact-form" action={endpoint} method="post" target="contact-sink" onSubmit={handleSubmit}>
        <div className="form-grid">
          ...
          <label className="full-field"><span>Where could AI make the biggest difference?</span><textarea name="entry.269626038" rows={3} maxLength={1200} placeholder="A workflow, an opportunity, or a business problem worth exploring." /></label>
        </div>
        ...
        <button className="button button-dark form-submit" type="submit" disabled={submitted}><span>{submitted ? "Sending…" : "Request 30 minutes"}</span></button>
