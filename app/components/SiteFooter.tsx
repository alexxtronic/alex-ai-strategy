...
export function SiteFooter() {
  return (
    <footer className="site-footer">
      ...
      <nav className="footer-nav" aria-label="Footer navigation"><Link href="/#process">Process</Link><Link href="/#proof">Proof</Link><Link href="/#work">Case studies</Link><Link href="/#team">Team</Link><Link href="/insights">Insights</Link><Link href="/ai-roi-calculator">ROI calculator</Link></nav>
